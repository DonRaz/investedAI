...
import { ArrowRight, BarChart2, Calculator, PiggyBank, Shield, TrendingUp, Zap } from "lucide-react";
import { Language, useTranslationStore, landingTranslations } from "@/lib/translations";
    ...
    >
      <Card className="group h-full border border-border/40 bg-background/60 backdrop-blur-sm transition-all hover:border-emerald-500/20 hover:shadow-md dark:border-border/20 dark:bg-background/40 dark:hover:border-emerald-500/20">
        ...
        <CardFooter className="justify-center md:justify-start">
          <Button variant="ghost" size="sm" className="group-hover:text-emerald-600 dark:group-hover:text-emerald-400" asChild>
            <a href={link}>
    ...
    >
      <Card className="h-full border border-border/40 bg-background/60 backdrop-blur-sm dark:border-border/20 dark:bg-background/40">
        <CardContent className="pt-6 flex flex-col h-full">
          <p className="mb-4 italic text-muted-foreground flex-grow">"{content}"</p>
          <div className="flex items-center gap-3 mt-auto">
            <Avatar>
              <AvatarImage src={avatarSrc} />
              <AvatarFallback className="bg-emerald-100 text-emerald-800 dark:bg-emerald-900 dark:text-emerald-200">{author[0]}</AvatarFallback>
            </Avatar>
            <div>
      ...
      <div className="space-y-4 w-full">
        ...
        <ul className="space-y-2">
          {benefits.map((benefit, index) => (
            <li key={index} className="flex items-start gap-2 md:justify-start justify-center">
        ...
        <div className="flex justify-center md:justify-start">
          <Button className="bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-700 dark:hover:bg-emerald-800 text-white" asChild>
...
export default function Home({ params: { lang } }: { params: { lang: Language } }) {
  ...
  return (
    <div className="relative w-full overflow-x-hidden bg-zinc-200 dark:bg-zinc-900">
      ...
      <section className="py-16 md:py-24 w-full bg-zinc-200 dark:bg-zinc-950" id="why-invested-ai">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-zinc-200 via-zinc-300 to-zinc-200 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-900 w-full" id="how-it-works">
        <div className="container px-4 md:px-6 mx-auto">
          <SectionHeader
      ...
      {/* Calculators Section */}
      <section className="py-16 md:py-24 w-full bg-zinc-200 dark:bg-zinc-950" id="calculators">
        <div className="container px-4 md:px-6 mx-auto">
          <SectionHeader
